              ...
              >
                <button
                  onClick={async () => {
                    ...
                    setIsExporting(true);
                    try {
                      await api.exportListFile('bill-desk', { search, status: status !== 'All' ? status : undefined, invoiceStatus: invoiceStatus !== 'All' ? invoiceStatus : undefined, billMonth: billMonth !== 'All' ? billMonth : undefined, hasObjectionRemarks: hasObjectionRemarks || undefined, projectNo: projectNo || undefined, minAmount: minAmount || undefined, maxAmount: maxAmount || undefined, invoiceDateFrom: invoiceDateFrom || undefined, invoiceDateTo: invoiceDateTo || undefined, receivedDateFrom: receivedDateFrom || undefined, receivedDateTo: receivedDateTo || undefined }, 'excel');
